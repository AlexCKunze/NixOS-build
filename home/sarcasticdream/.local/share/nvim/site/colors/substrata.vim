...
" Last Updated: Wed 30 Oct 20:59:09 2019
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#2e313d', '#cf8164', '#76a065', '#ab924c',
        \ '#8296b0', '#a18daf', '#659ea2', '#b5b4c9', '#5b5f71', '#fe9f7c',
        \ '#92c47e', '#d2b45f', '#a0b9d8', '#c6aed7', '#7dc2c7', '#f0ecfe']
  if has('nvim')
  ...
  hi Normal guifg=#b5b4c9 guibg=#191c25 guisp=NONE gui=NONE cterm=NONE
  hi Cursor guifg=#191c25 guibg=#f0ecfe guisp=NONE gui=NONE cterm=NONE
  hi None guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi CursorLineNr guifg=#6c6f82 guibg=#20222d guisp=NONE gui=NONE cterm=NONE
  hi FoldColumn guifg=#3c3f4e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Folded guifg=#6c6f82 guibg=#272935 guisp=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#3c3f4e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi MatchParen guifg=#f0ecfe guibg=#2e313d guisp=NONE gui=bold cterm=bold
  hi SignColumn guifg=#3c3f4e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Ignore guifg=#3c3f4e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Pmenu guifg=#6c6f82 guibg=#272935 guisp=NONE gui=NONE cterm=NONE
  hi PmenuSbar guifg=#272935 guibg=#272935 guisp=NONE gui=NONE cterm=NONE
  hi PmenuSel guifg=#f0ecfe guibg=#2e313d guisp=NONE gui=NONE cterm=NONE
  hi PmenuThumb guifg=#20222d guibg=#20222d guisp=NONE gui=NONE cterm=NONE
  hi ErrorMsg guifg=#fe9f7c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi ModeMsg guifg=#5b5f71 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi MoreMsg guifg=#a0b9d8 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Question guifg=#a0b9d8 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi WarningMsg guifg=#d2b45f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi ColorColumn guifg=NONE guibg=#20222d guisp=NONE gui=NONE cterm=NONE
  hi CursorColumn guifg=NONE guibg=#20222d guisp=NONE gui=NONE cterm=NONE
  hi CursorLine guifg=NONE guibg=#20222d guisp=NONE gui=NONE cterm=NONE
  hi QuickFixLine guifg=NONE guibg=#2e313d guisp=NONE gui=NONE cterm=NONE
  hi StatusLine guifg=#6c6f82 guibg=#2e313d guisp=NONE gui=NONE cterm=NONE
  hi StatusLineNC guifg=#5b5f71 guibg=#272935 guisp=NONE gui=NONE cterm=NONE
  hi VertSplit guifg=#3c3f4e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#191c25 guibg=#b5b4c9 guisp=NONE gui=NONE cterm=NONE
  hi IncSearch guifg=#191c25 guibg=#b5b4c9 guisp=NONE gui=NONE cterm=NONE
  hi Search guifg=#191c25 guibg=#8296b0 guisp=NONE gui=NONE cterm=NONE
  hi Visual guifg=NONE guibg=#2e313d guisp=NONE gui=NONE cterm=NONE
  hi DiffAdd guifg=#92c47e guibg=#1c2316 guisp=NONE gui=NONE cterm=NONE
  hi DiffChange guifg=NONE guibg=#272935 guisp=NONE gui=NONE cterm=NONE
  hi DiffDelete guifg=#fe9f7c guibg=#2d1d16 guisp=NONE gui=NONE cterm=NONE
  hi DiffText guifg=#d2b45f guibg=#262011 guisp=NONE gui=NONE cterm=NONE
  hi Comment guifg=#5b5f71 guibg=NONE guisp=NONE gui=italic cterm=italic
  hi Constant guifg=#a18daf guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Error guifg=#cf8164 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#8296b0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Special guifg=#7dc2c7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Statement guifg=#8296b0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Type guifg=#a18daf guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Delimiter guifg=#6c6f82 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Directory guifg=#8296b0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Function guifg=#a0b9d8 guibg=NONE guisp=NONE gui=italic cterm=italic
  hi Operator guifg=#6c6f82 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi SpecialComment guifg=#f0ecfe guibg=NONE guisp=NONE gui=italic cterm=italic
  hi String guifg=#659ea2 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Title guifg=#f0ecfe guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Todo guifg=#f0ecfe guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Typedef guifg=#c6aed7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Underlined guifg=#a0b9d8 guibg=NONE guisp=NONE gui=underline cterm=underline
  ...
  hi SpellCap guifg=#cf8164 guibg=NONE guisp=#cf8164 gui=undercurl cterm=undercurl
  hi SpellLocal guifg=#cf8164 guibg=NONE guisp=#cf8164 gui=undercurl cterm=undercurl
  hi SpellRare guifg=#cf8164 guibg=NONE guisp=#cf8164 gui=undercurl cterm=undercurl
  if !s:italics
  ...
  hi markdownUrl guifg=#5b5f71 guibg=NONE guisp=NONE gui=underline cterm=underline
  hi markdownCode guifg=NONE guibg=#272935 guisp=NONE gui=NONE cterm=NONE
  hi markdownFaded guifg=#5b5f71 guibg=NONE guisp=NONE gui=NONE cterm=NONE
...
""if s:t_Co >= 256
  ...
  hi StatusLine ctermfg=242 ctermbg=236 cterm=NONE
  ...
  hi SpellCap ctermfg=173 ctermbg=NONE cterm=undercurl
  hi SpellLocal ctermfg=173 ctermbg=NONE cterm=undercurl
  hi SpellRare ctermfg=173 ctermbg=NONE cterm=undercurl
  if !s:italics
